...
| REQ-002 | Grid Trading Excel Calculator | Development Done | 2026-04-12 | A Python script (openpyxl) that generates a formatted .xlsx grid trading worksheet: 9 adjustable parameters, per-grid P&L table with position tracking and avg cost, summary statistics block, and color-coded warnings. |
